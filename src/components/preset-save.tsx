  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="secondary" className="text-xs sm:text-sm font-semibold h-8 sm:h-9 px-2 sm:px-3">
          <Save className="w-3 h-3 sm:w-4 sm:h-4" />
          <span className="md:ml-1 sm:md:ml-2 hidden md:block">Save</span>
        </Button>
      </DialogTrigger>
