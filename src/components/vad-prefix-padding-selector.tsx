            ...
            <HoverCardTrigger asChild>
              <FormItem>
                <div className="flex items-center justify-between">
                  <FormLabel className="text-xs sm:text-sm">Prefix Padding (ms)</FormLabel>
                  <FormControl>
                    <Input
                      {...field}
                      className={`shadow-none font-light py-0 h-7 sm:h-8 max-w-[80px] sm:max-w-[100px] text-right text-xs sm:text-sm ${
